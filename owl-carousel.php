...
$slides = [
  ["img" => "https://picsum.photos/300/200", "title" => "First Slide",  "caption" => "Your catchy caption"],
  ["img" => "https://picsum.photos/300/200", "title" => "Second Slide", "caption" => "Another caption"],
  ["img" => "https://picsum.photos/300/200", "title" => "Third Slide",  "caption" => "Last caption"],
];
?>
<!doctype html>
<html lang="en">
